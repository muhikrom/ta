            ...
            <div class="card">
              <div class="card-body">
                <div class="card-body">
                  ...
                  <form action="<?php echo site_url('backend/data_obat_keluar/proses_addout') ?>" method="post" enctype="multipart/form-data">
					...
					<div class="form-group">
						...
						<input type="date" name="tgl_obat_keluar" id="tgl_obat_keluar" class="form-control" value="<?php echo set_value('tgl_obat_keluar')?>" >
						<small style="color: red"><?= form_error('tgl_obat_masuk');?></small>
					</div>
					<div class="form-group">
						<label for="kd_rekam_medik">Pasien</label>
						<input type="number" name="kd_rekam_medik" id="kd_rekam_medik" class="form-control" value="<?php echo set_value('kd_rekam_medik')?>" >
						<small style="color: red"><?= form_error('kd_rekam_medik');?></small>
					</div>
					<div class="form-group">
						<label for="jumlah">Jumlah</label>
						<input type="number" name="jumlah" id="jumlah" class="form-control" value="<?php echo set_value('jumlah')?>" >
						<small style="color: red"><?= form_error('jumlah');?></small>
					</div>
					<div class="form-group">
